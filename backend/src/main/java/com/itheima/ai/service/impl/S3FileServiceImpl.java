...
public class S3FileServiceImpl implements S3FileService {
    ...
    public StoredObjectInfo uploadImage(Long userId, String chatId, MultipartFile file) {
        return uploadFile(userId, chatId, file, "images");
    }

    @Override
    public StoredObjectInfo uploadPdf(Long userId, String chatId, MultipartFile file) {
        return uploadFile(userId, chatId, file, "pdfs");
    }
    ...
    private StoredObjectInfo uploadFile(Long userId, String chatId, MultipartFile file, String category) {
        ...
        String key = buildObjectKey(userId, chatId, category, originalFilename);
    ...
    private String buildObjectKey(Long userId, String chatId, String category, String originalFilename) {
        String date = LocalDate.now().format(DATE_FORMATTER);
        String uuid = UUID.randomUUID().toString();
        return category + "/" + userId + "/" + chatId + "/" + date + "/" + uuid + "-" + originalFilename;
    }
}
